...
namespace OurSecrets
{
    ...
    /// </summary>
    public sealed partial class SearchResultsPage1 : OurSecrets.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            List<Agenda> list = App.AgendasModel.GetAgendaList();
            foreach (Agenda agenda in list)
            {
                if (agenda.Title.Contains(navigationParameter as string))
                {
        ...
        /// </summary>
        private sealed class Filter : OurSecrets.Common.BindableBase
        {
